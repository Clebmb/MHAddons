<img src="https://github.com/user-attachments/assets/9f8f236c-eac8-492b-88db-58710e74ed52" width="128" height="128">
...
<img width="800" height="650" alt="zen_leQXe6L9hF" src="https://github.com/user-attachments/assets/48d962d5-d1d9-4e1e-988c-aad84a87740a" />
...
<img width="800" height="650" alt="zen_PyGc8tWp0Y" src="https://github.com/user-attachments/assets/f66481ca-ac51-4146-9540-678b2c87e25b" />
...
<img width="800" height="650" alt="zen_nUfh9peOzf" src="https://github.com/user-attachments/assets/8b6751e9-ec2b-4281-967d-4098eeafa721" />
...
- `MHStreams` UI at `http://localhost:3000`
- `MHStreams` addon backend at `http://localhost:3001`
- `MHMetadata` UI at `http://localhost:5173`
- `MHMetadata` addon backend at `http://localhost:3232`
- `MHTV` at `http://localhost:7000`
>>>>>>> 01ef6b42fc20aeda76653ce41a31a5cfc31431af
