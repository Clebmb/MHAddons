...
export const REDIS_PREFIX = 'mhstreams:';
...
> = {
  [BUILTIN_SERVICE]: {
    id: BUILTIN_SERVICE,
    name: 'Builtin Proxy',
    description: 'A proxy service that is built into the core of MHStreams',
    credentialDescription:
      'A valid username:password pair for this MHStreams instance, defined in the `MHSTREAMS_AUTH` environment variable.',
  },
  [STREMTHRU_SERVICE]: {
...
> = {
  ...
  [NZBDAV_SERVICE]: {
    ...
    credentials: [
      ...
      {
        id: 'mhstreamsAuth',
        name: 'MHStreams Auth Token (Optional)',
        description:
          'If you would like to proxy your NzbDAV streams, you will need to provide a username:password pair for your MHStreams instance, defined in the `MHSTREAMS_AUTH` environment variable. **Other proxies will not work and you must define it here only**',
        type: 'password',
        required: false,
      },
    ],
  ...
  [ALTMOUNT_SERVICE]: {
    ...
    credentials: [
      ...
      },
      {
        ...
        name: 'MHStreams Auth Token (Optional)',
        description:
          'If you would like to proxy your AltMount streams, you will need to provide a username:password pair for your MHStreams instance, defined in the `MHSTREAMS_AUTH` environment variable. **Other proxies will not work and you must define it here only**',
        type: 'password',
        required: false,
      },
    ],
  ...
  [STREMTHRU_NEWZ_SERVICE]: {
    ...
    credentials: [
      ...
      },
      {
        ...
        name: 'Tip',
        description:
          'If you are self-hosting both StremThru and MHStreams, consider using the internal URL of StremThru (e.g., http://stremthru:8080) to avoid potential network issues. Your playback URLs generated by StremThru will use the `STREMTHRU_BASE_URL` environment variable.',
        type: 'alert',
        intent: 'info',
      },
    ],
