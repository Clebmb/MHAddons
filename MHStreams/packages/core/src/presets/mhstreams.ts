...
class MHStreamsStreamParser extends StreamParser {
...
export class MHStreamsPreset extends Preset {
    static override getParser(): typeof StreamParser {
        return MHStreamsStreamParser;
    }
    ...
    static override get METADATA() {
        const options: Option[] = [
            ...
            },
            {
                id: 'manifestUrl',
                name: 'Manifest URL',
                description: 'Provide the Manifest URL for this MHStreams addon.',
                type: 'url',
                required: true,
            },
            {
        ...
        return {
            ID: 'mhstreams',
            NAME: 'MHStreams',
            LOGO: 'https://raw.githubusercontent.com/Clebmb/MHStreams/refs/heads/main/packages/frontend/public/logo.webp',
            URL: '',
            TIMEOUT: Env.DEFAULT_TIMEOUT,
            USER_AGENT: Env.MHSTREAMS_USER_AGENT,
            SUPPORTED_SERVICES: [],
            DESCRIPTION: 'Wrap MHStreams within MHStreams!',
            OPTIONS: options,
