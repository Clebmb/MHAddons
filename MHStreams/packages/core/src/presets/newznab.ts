...
export class NewznabPreset extends BuiltinAddonPreset {
  ...
  static override get METADATA() {
    ...
    const options: Option[] = [
      ...
      {
        id: 'proxyAuth',
        name: 'MHStreams Proxy Auth',
        description: `${Env.NZB_PROXY_PUBLIC_ENABLED ? 'This instance will proxy NZBs by default, however you can optionally p' : 'P'}rovide a username:password pair from the \`MHSTREAMS_AUTH\` environment variable to use for proxying the NZB.`,
        type: 'password',
        required: false,
      },
      {
