...
export const instances: Instance[] = [
  {
    ...
    stable: 'https://mhstreams.elfhosted.com',
  },
  {
    id: 'yeb',
    name: "Yeb's",
    ...
    description: 'Hosted by an MHStreams Discord admin.',
    stable: 'https://mhstreams.fortheweak.cloud',
    nightly: 'https://mhstreams-nightly.fortheweak.cloud',
  },
  {
    id: 'midnight',
    name: "Midnight's",
    ...
    stable: 'https://mhstreamsfortheweebsstable.midnightignite.me',
    nightly: 'https://mhstreamsfortheweebs.midnightignite.me',
  },
  {
    id: 'viren',
    name: "Viren's",
    ...
    nightly: 'https://mhstreams.viren070.me',
  },
  {
    id: 'kuu',
    name: "Kuu's",
    stable: 'https://mhstreams.stremio.ru',
    nightly: 'https://mhstreams-nightly.stremio.ru',
  },
  {
    id: 'atbp',
    name: 'ATBP Hosting',
  ...
  },
  {
    ...
    name: "Omni's",
    hostedBy: '@a.ves',
    stable: 'https://mhstreams.12312023.xyz',
  },
];
