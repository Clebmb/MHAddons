  ...
  return (
    <>
      <SettingsCard
        ...
        description="MHStreams will return the statistics of stream fetches and response times for each addon if enabled."
      >
        <Switch
          label="Enable"
          side="right"
      ...
      <SettingsCard title="Hide Errors">
        <Switch
          label="Hide Errors"
          help="MHStreams will attempt to return the errors in responses to streams, catalogs etc. Turning this on will hide the errors."
          side="right"
