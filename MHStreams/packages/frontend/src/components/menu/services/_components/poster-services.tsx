  ...
  return (
    ...
    >
      ...
      <Switch
        ...
        help={
          <span>
            If enabled, MHStreams will use the selected poster service to fetch
      ...
      <Switch
        ...
        help={
          <span>
            If enabled, poster URLs will first contact MHStreams and then be
            ...
            slowdown due to having to contact MHStreams first.
          </span>
        }
