    ...
    <>
      ...
      >
        <Switch
          ...
          help="When enabled, MHStreams configures supported addons to return raw torrents, then resolves them through your debrid services."
        />
      ...
      <SettingsCard
        title="NZB Failover"
        description="When a Usenet stream fails to play, MHStreams will automatically try the next best NZB URLs from your sorted results. Only applies to built-in Usenet addons."
      >
        <Switch
          label="Enable"
          side="right"
