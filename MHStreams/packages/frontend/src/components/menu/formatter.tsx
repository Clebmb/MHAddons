      ...
      {userData.formatter.id === constants.CUSTOM_FORMATTER && (
        ...
        >
          <div className="text-sm text-gray-400">
            ...
            <a
              href="https://docs.mhstreams.viren070.me/reference/custom-formatter"
              target="_blank"
            ...
            <a
              href="https://github.com/Viren070/MHStreams/blob/main/packages/core/src/formatters/predefined.ts"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[--brand] hover:text-[--brand]/80 hover:underline"
            >
