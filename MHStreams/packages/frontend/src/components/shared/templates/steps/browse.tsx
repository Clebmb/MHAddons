          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            {(hasWarnings || hasErrors) && (
              <button
                ...
                className={`w-6 h-6 flex items-center justify-center rounded transition-colors ${hasErrors
          ...
          <div className="flex gap-1.5 overflow-x-auto min-w-0 flex-1 pb-2">
            {sources.map((source: string) => {
              const sourceDescription: Record<string, string> = {
                all: 'All sources',
                builtin: 'Provided with MHStreams',
                ...
                <Tooltip
                  ...
                  trigger={
                    <button
                      ...
                      className={`px-3 py-1 text-xs font-medium rounded transition-colors whitespace-nowrap flex-shrink-0 ${selectedSource === source && source === 'all'
