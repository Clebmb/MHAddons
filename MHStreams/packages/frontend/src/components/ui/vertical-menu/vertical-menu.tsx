...
export const VerticalMenuAnatomy = defineStyleAnatomy({
  ...
  item: cva(
    [
      ...
      'group/verticalMenu_item relative flex flex-none justify-start truncate items-center w-full text-left font-medium rounded-[--radius] transition cursor-pointer',
      'hover:bg-[--subtle] hover:text-[--foreground]',
      'focus-visible:bg-[--subtle] outline-none text-[--muted]',
      'data-[current=true]:bg-[#39E079] data-[current=true]:text-black data-[current=true]:font-semibold data-[current=true]:shadow-[0_4px_15px_rgba(57,224,121,0.2)]',
    ],
    {
      variants: {
        collapsed: {
  ...
  itemIcon: cva(
    [
      ...
      'flex-shrink-0 mr-3',
      'text-[#3cde78] text-xl',
      'group-hover/verticalMenu_item:text-[#3cde78]',
      'group-data-[current=true]/verticalMenu_item:text-black',
    ],
    {
      variants: {
        size: {
